...
/**
 * The class FillPatternForwardIcon.
 */
public class FillPatternForwardIcon extends FillPatternIcon {
	...
	public void drawIcon(Graphics2D g2, int x, int y, int w, int h, Props params) {
		...
		BarChartLayer.patternFill(g2, FillPattern.FORWARD_HATCH, x, y, w, h);
	}
}
