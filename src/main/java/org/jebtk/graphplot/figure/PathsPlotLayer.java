...
public abstract class PathsPlotLayer extends UniqueXYLayer {
	...
	public final void plotLayer(Graphics2D g2, DrawingContext context, Figure figure, SubFigure subFigure, Axes axes,
		...
		plotLayer(g2, context, figure, subFigure, axes, plot, m, series, xy, mPaths.getValue());
	}
	...
	public abstract void plotLayer(Graphics2D g2, DrawingContext context, Figure figure, SubFigure subFigure, Axes axes,
			Plot plot, DataFrame m, XYSeries series, UniqueXY xy, List<GeneralPath> path);
	 ...
	 * @return the path
	 */
	protected abstract List<GeneralPath> getPaths(Figure figure, SubFigure subFigure, Axes axes, Plot plot, DataFrame m,
